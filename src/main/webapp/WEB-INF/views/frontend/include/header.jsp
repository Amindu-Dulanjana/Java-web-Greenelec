            ...
            <div class="row mb-1">
                ...
                <div class="col-2 col-md-6 col-lg-7 mb-1 dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item fw-bold" href="#">Wishlist</a></li>
                        <li><a class="dropdown-item fw-bold" href="#">Purchase History</a></li>
                        <li><a class="dropdown-item fw-bold" href="#">Message</a></li>
                        <li><a class="dropdown-item fw-bold" href="#">My Products</a></li>
                        <li><a class="dropdown-item fw-bold" href="#">My Profile</a></li>
                        <!-- <li><a class="dropdown-item" href="#">My Sellings</a></li> -->
                    </ul>
                </div>
                <div class="col-1 col-md-1 col-lg-3 ms-5 ms-lg-0 carticon" onclick="cart();"><i class="bi bi-cart3 fs-4"></i></div>
            </div>
        </div>
    </div>
</div>
